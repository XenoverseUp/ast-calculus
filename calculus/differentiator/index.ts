  ...
  switch (expr.type) {
    ...
    case "ExponentialExpr": {
      ...
      if (
        ...
        return MAKE_ARITH(
          ArithOperator.Mult,
          exponent,
          MAKE_EXPONENT(base, MAKE_CONST(exponent.value - 1))
        )
      }
      ...
      switch (operator) {
        ...
        case ArithOperator.Mult:
          ...
          return MAKE_ARITH(
            ...
            MAKE_ARITH(ArithOperator.Mult, left, differentiate(right, variable))
          )
    ...
    case "UnaryFunctionExpr": {
      ...
      switch (functionName) {
        ...
        case UnaryFunction.NaturalLog:
          return MAKE_ARITH(ArithOperator.Div, innerDerivative, argument)

        default:
          throw new Error(`Unsupported unary function: ${functionName}`)
      }
    }
    ...
    case "BinaryFunctionExpr": {
      ...
      switch (functionName) {
          ...
          return MAKE_ARITH(
            ...
            MAKE_ARITH(
              ...
              MAKE_ARITH(
                ...
                MAKE_EXPONENT(
                  arg1,
                  MAKE_ARITH(ArithOperator.Minus, arg2, MAKE_CONST(1))
                )
              ),
            ...
            MAKE_ARITH(
              ...
              MAKE_ARITH(
                ArithOperator.Mult,
                MAKE_UNARY_FUNCTION(UnaryFunction.NaturalLog, arg1),
        ...
        default:
          throw new Error(`Unsupported binary function: ${functionName}`)
      }
    }
  }
